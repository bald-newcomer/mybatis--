...
public class MetaObjectTest {
    ...
    public void shouldGetAndSetField() {
        ...
        //在之前的RichType对象中，加入新的属性richField，并赋值foo，而这一切都是通过MetaObject进行维护的
        //对MetaObject来说，就是在originalObject中加了个属性richField，并赋值为foo，这一切的根源就是反射的field.set方法
        meta.setValue("richField", "foo");
        //getValue还没来得及看，这个有递归呦，但此处未用到
        assertEquals("foo", meta.getValue("richField"));
    }

    /**
     * 在RichType中，对richType中的richField进行赋值，
     * todo 至于其中的递归情况，就不想看了有空再看
     */
    @Test
